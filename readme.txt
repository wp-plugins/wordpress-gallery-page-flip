...
Wordpress Gallery plugin helps you to create Image Gallery with Page Flip effects on your blog.  
...
Try Wordpress Galery Page Flip plugin - image gallery with fipping book effect.
...
1. Unpack the *.zip file and extract the /wordpress-gallery-page-flip/ folder.
2. Using an FTP program, upload the /wordpress-gallery-page-flip/ folder to your WordPress plugins directory (Example: /wp-content/plugins/).
